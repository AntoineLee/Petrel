...
#define FFMPEG_CONFIGURATION "--disable-shared --enable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-encoders --enable-jni --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=jpeg2000 --enable-encoder=ljpeg --disable-hwaccels --disable-devices --enable-network --disable-muxers --enable-muxer=image2 --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=mpegts --enable-filters --enable-parsers --disable-debug --enable-cross-compile --target-os=android --enable-gpl --enable-nonfree --arch=arm --enable-pic --disable-debug --prefix=./output --extra-libs=-lgcc --cc=/Users/yanjia/Android/android-ndk-r10e/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64//bin/arm-linux-androideabi-gcc --cross-prefix=/Users/yanjia/Android/android-ndk-r10e/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64//bin/arm-linux-androideabi- --nm=/Users/yanjia/Android/android-ndk-r10e/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64//bin/arm-linux-androideabi-nm --sysroot=/Users/yanjia/Android/android-ndk-r10e/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --extra-ldflags='-Wl,-rpath-link=/Users/yanjia/Android/android-ndk-r10e/platforms/android-8/arch-arm//usr/lib -L/Users/yanjia/Android/android-ndk-r10e/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-neon"
