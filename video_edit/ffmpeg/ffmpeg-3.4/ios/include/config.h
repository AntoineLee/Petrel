...
#define FFMPEG_CONFIGURATION "--disable-shared --enable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-encoders --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=jpeg2000 --enable-encoder=ljpeg --disable-hwaccels --enable-videotoolbox --enable-hwaccel=h264_videotoolbox --disable-devices --enable-network --disable-muxers --enable-muxer=image2 --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=mpegts --enable-filters --enable-parsers --disable-debug --disable-bzlib --disable-iconv --disable-zlib --enable-cross-compile --arch=arm --enable-pic --disable-debug --disable-asm --enable-pic --arch=arm --target-os=darwin --arch=x86_64 --cpu=x86_64 --cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --extra-ldflags='-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator11.2.sdk/usr/lib/system -miphoneos-version-min=7.0' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator11.2.sdk --extra-cflags='-miphoneos-version-min=7.0 -fembed-bitcode' --extra-cxxflags=-fembed-bitcode"
