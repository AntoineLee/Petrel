...
VEPLAYER_COMMON_PATH := ../../../../player/common
VEPLAYER_SRC_PATH := ../../../../player/src
VIDEO_EDIT_SRC_UNIT_TEST_PATH := ../../../../video_edit/src/unit_test
...
include $(CLEAR_VARS)
LOCAL_MODULE := vePlayerTest

LOCAL_CXXFLAGS += -DANDROID_NDK -Wall -D_ANDROID -DNO_CRYPTO -DCRYPTO=3 -fexceptions -std=c++11 -fpermissive
...
LOCAL_SRC_FILES += $(VIDEO_EDIT_SRC_UNIT_TEST_PATH)/VEUnitTest.cpp \
				   $(VIDEO_EDIT_SRC_UNIT_TEST_PATH)/VEUnitTestConfig.cpp 


LOCAL_SRC_FILES += $(VEPLAYER_SRC_PATH)/VEAudioManager.cpp \
				   $(VEPLAYER_SRC_PATH)/VEAudioRenderSL.cpp \
				   $(VEPLAYER_SRC_PATH)/VEGraphManager.cpp \
				   $(VEPLAYER_COMMON_PATH)/mbuf.c \
				   $(VEPLAYER_SRC_PATH)/VEMediaSource.cpp \
				   $(VEPLAYER_SRC_PATH)/VEPlayer.cpp \
				   $(VEPLAYER_SRC_PATH)/VEPlayerUtils.cpp \
                   $(VEPLAYER_SRC_PATH)/VEVideoManager.cpp \
                   $(VEPLAYER_SRC_PATH)/audio_producer/VEAudioProducer.cpp \
                   $(VEPLAYER_SRC_PATH)/unit_test/VETestAudioProducer.cpp \
                   $(VEPLAYER_SRC_PATH)/unit_test/VETestPlayer.cpp  \
                   $(VEPLAYER_SRC_PATH)/unit_test/VETestUtils.cpp  \
                   $(VEPLAYER_SRC_PATH)/unit_test/VETestGTest.cpp  
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/ \
					...
					$(LOCAL_PATH)/../../../../player/src/unit_test/ \
					$(LOCAL_PATH)/../../../../player/src/audio_producer/ \
					$(LOCAL_PATH)/../../../../player/common/ \
					$(LOCAL_PATH)/../../../../player/src/ \
					...
					$(LOCAL_PATH)/../../../../video_edit/src/unit_test/ \
