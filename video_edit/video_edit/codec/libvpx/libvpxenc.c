...
#define CONFIG_LIBVPX_VP8_ENCODER_VE 1
/**
...
FF_ENABLE_DEPRECATION_WARNINGS
    ...
    if (CONFIG_LIBVPX_VP8_ENCODER_VE && avctx->codec_id == AV_CODEC_ID_VP8) {
#if FF_API_PRIVATE_OPT
FF_DISABLE_DEPRECATION_WARNINGS
...
#if CONFIG_LIBVPX_VP8_ENCODER_VE
...
#endif /* CONFIG_LIBVPX_VP8_ENCODER_VE */
