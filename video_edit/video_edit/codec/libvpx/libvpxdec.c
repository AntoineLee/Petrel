...
#define CONFIG_LIBVPX_VP8_DECODER_VE 1
    ...
    if (side_data_size > 1) {
        ...
        if (additional_id == 1) {  // 1 stands for alpha channel data.
            if (!ctx->has_alpha_channel) {
                ...
                ret = vpx_init(avctx,
#if CONFIG_LIBVPX_VP8_DECODER_VE && CONFIG_LIBVPX_VP9_DECODER
                               (avctx->codec_id == AV_CODEC_ID_VP8) ?
                               &vpx_codec_vp8_dx_algo : &vpx_codec_vp9_dx_algo,
#elif CONFIG_LIBVPX_VP8_DECODER_VE
...
#if CONFIG_LIBVPX_VP8_DECODER_VE
...
#endif /* CONFIG_LIBVPX_VP8_DECODER_VE */
