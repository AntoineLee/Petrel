...
int ff_AMediaCodecProfile_getProfileFromAVCodecContext(AVCodecContext *avctx)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodecProfile_getProfileFromAVCodecContext");
...
char *ff_AMediaCodecList_getCodecNameByType(const char *mime, int profile, int encoder, void *log_ctx)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodecList_getCodecNameByType");
...
FFAMediaFormat *ff_AMediaFormat_new(void)
{
    ...
    jobject object = NULL;
    //VE_LOG_INFO("ff_AMediaFormat_new");
...
static FFAMediaFormat *ff_AMediaFormat_newFromObject(void *object)
{
    JNIEnv *env = NULL;
    FFAMediaFormat *format = NULL;
    //VE_LOG_INFO("ff_AMediaFormat_newFromObject");
    format = av_mallocz(sizeof(FFAMediaFormat));
    if (!format) {
        return NULL;
    }
...
int ff_AMediaFormat_delete(FFAMediaFormat* format)
{
    ...
    //VE_LOG_INFO("ff_AMediaFormat_delete");
...
char* ff_AMediaFormat_toString(FFAMediaFormat* format)
{
    ...
    //VE_LOG_INFO("ff_AMediaFormat_toString");
...
int ff_AMediaFormat_getInt32(FFAMediaFormat* format, const char *name, int32_t *out)
{
    ...
    //VE_LOG_INFO("ff_AMediaFormat_getInt32");
...
int ff_AMediaFormat_getInt64(FFAMediaFormat* format, const char *name, int64_t *out)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, format, 0);
    //VE_LOG_INFO("ff_AMediaFormat_getInt64");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        ret = 0;
        goto fail;
...
int ff_AMediaFormat_getFloat(FFAMediaFormat* format, const char *name, float *out)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, format, 0);
    //VE_LOG_INFO("ff_AMediaFormat_getFloat");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        ret = 0;
        goto fail;
...
int ff_AMediaFormat_getBuffer(FFAMediaFormat* format, const char *name, void** data, size_t *size)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, format, 0);
    //VE_LOG_INFO("ff_AMediaFormat_getBuffer");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        ret = 0;
        goto fail;
...
int ff_AMediaFormat_getString(FFAMediaFormat* format, const char *name, const char **out)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, format, 0);
    //VE_LOG_INFO("ff_AMediaFormat_getString");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        ret = 0;
        goto fail;
...
void ff_AMediaFormat_setInt32(FFAMediaFormat* format, const char* name, int32_t value)
{
    ...
    //VE_LOG_INFO("ff_AMediaFormat_setInt32");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        goto fail;
    }
...
void ff_AMediaFormat_setInt64(FFAMediaFormat* format, const char* name, int64_t value)
{
    ...
    JNI_GET_ENV_OR_RETURN_VOID(env, format);
    //VE_LOG_INFO("ff_AMediaFormat_setInt64");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        goto fail;
    }
...
void ff_AMediaFormat_setFloat(FFAMediaFormat* format, const char* name, float value)
{
    ...
    JNI_GET_ENV_OR_RETURN_VOID(env, format);
    //VE_LOG_INFO("ff_AMediaFormat_setFloat");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        goto fail;
    }
...
void ff_AMediaFormat_setString(FFAMediaFormat* format, const char* name, const char* value)
{
    ...
    JNI_GET_ENV_OR_RETURN_VOID(env, format);
    //VE_LOG_INFO("ff_AMediaFormat_setString");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        goto fail;
    }
...
void ff_AMediaFormat_setBuffer(FFAMediaFormat* format, const char* name, void* data, size_t size)
{
    ...
    JNI_GET_ENV_OR_RETURN_VOID(env, format);
    //VE_LOG_INFO("ff_AMediaFormat_setBuffer");
    key = ff_jni_utf_chars_to_jstring(env, name, format);
    if (!key) {
        goto fail;
    }
...
FFAMediaCodec* ff_AMediaCodec_createCodecByName(const char *name)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_createCodecByName");
    ...
    //VE_LOG_INFO("ff_AMediaCodec_createCodecByName 1");
    if (codec->jfields.get_input_buffer_id && codec->jfields.get_output_buffer_id) {
    	//VE_LOG_INFO("ff_AMediaCodec_createCodecByName 2");
...
FFAMediaCodec* ff_AMediaCodec_createDecoderByType(const char *mime)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_createDecoderByType");
    codec = av_mallocz(sizeof(FFAMediaCodec));
    if (!codec) {
        return NULL;
    }
    ...
    //VE_LOG_INFO("ff_AMediaCodec_createDecoderByType 1");
    if (codec->jfields.get_input_buffer_id && codec->jfields.get_output_buffer_id) {
    	//VE_LOG_INFO("ff_AMediaCodec_createDecoderByType 2");
        codec->has_get_i_o_buffer = 1;
    }
...
FFAMediaCodec* ff_AMediaCodec_createEncoderByType(const char *mime)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_createEncoderByType");
    codec = av_mallocz(sizeof(FFAMediaCodec));
    if (!codec) {
        return NULL;
    }
...
int ff_AMediaCodec_delete(FFAMediaCodec* codec)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_delete");
...
char *ff_AMediaCodec_getName(FFAMediaCodec *codec)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_getName");
...
int ff_AMediaCodec_configure(FFAMediaCodec* codec, const FFAMediaFormat* format, void* surface, void *crypto, uint32_t flags)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_configure");
...
int ff_AMediaCodec_start(FFAMediaCodec* codec)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, AVERROR_EXTERNAL);
    //VE_LOG_INFO("ff_AMediaCodec_start");
...
int ff_AMediaCodec_stop(FFAMediaCodec* codec)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, AVERROR_EXTERNAL);
    //VE_LOG_INFO("ff_AMediaCodec_stop");
...
int ff_AMediaCodec_flush(FFAMediaCodec* codec)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_flush");
...
int ff_AMediaCodec_releaseOutputBuffer(FFAMediaCodec* codec, size_t idx, int render)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_releaseOutputBuffer begin codec=0x%0x idx=%d render=%d", codec, idx, render);

    JNI_GET_ENV_OR_RETURN(env, codec, AVERROR_EXTERNAL);

    (*env)->CallVoidMethod(env, codec->object, codec->jfields.release_output_buffer_id, (jint)idx, (jboolean)render);
    if (ff_jni_exception_check(env, 1, codec) < 0) {
        //VE_LOG_INFO("ff_AMediaCodec_releaseOutputBuffer failed");
        ret = AVERROR_EXTERNAL;
        goto fail;
    }

    //VE_LOG_INFO("ff_AMediaCodec_releaseOutputBuffer end");
fail:
    return ret;
}
...
int ff_AMediaCodec_releaseOutputBufferAtTime(FFAMediaCodec *codec, size_t idx, int64_t timestampNs)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, AVERROR_EXTERNAL);
    //VE_LOG_INFO("ff_AMediaCodec_releaseOutputBufferAtTime");
...
ssize_t ff_AMediaCodec_dequeueInputBuffer(FFAMediaCodec* codec, int64_t timeoutUs)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_dequeueInputBuffer");
...
int ff_AMediaCodec_queueInputBuffer(FFAMediaCodec* codec, size_t idx, off_t offset, size_t size, uint64_t time, uint32_t flags)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, AVERROR_EXTERNAL);
    //VE_LOG_INFO("ff_AMediaCodec_queueInputBuffer");
...
ssize_t ff_AMediaCodec_dequeueOutputBuffer(FFAMediaCodec* codec, FFAMediaCodecBufferInfo *info, int64_t timeoutUs)
{
    ...
    //VE_LOG_INFO("ff_AMediaCodec_dequeueOutputBuffer");
...
uint8_t* ff_AMediaCodec_getInputBuffer(FFAMediaCodec* codec, size_t idx, size_t *out_size)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, NULL);
    //VE_LOG_INFO("ff_AMediaCodec_getInputBuffer");
...
uint8_t* ff_AMediaCodec_getOutputBuffer(FFAMediaCodec* codec, size_t idx, size_t *out_size)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, NULL);
    //VE_LOG_INFO("ff_AMediaCodec_getOutputBuffer");
    if (codec->has_get_i_o_buffer) {
    	//VE_LOG_INFO("ff_AMediaCodec_getOutputBuffer 1");
        ...
        if (!codec->output_buffers) {
            ...
            //VE_LOG_INFO("ff_AMediaCodec_getOutputBuffer 2");
...
FFAMediaFormat* ff_AMediaCodec_getOutputFormat(FFAMediaCodec* codec)
{
    ...
    JNI_GET_ENV_OR_RETURN(env, codec, NULL);
    //VE_LOG_INFO("ff_AMediaCodec_getOutputFormat");
...
{
    int ret = 0;
    //VE_LOG_INFO("ff_AMediaCodec_cleanOutputBuffers");
