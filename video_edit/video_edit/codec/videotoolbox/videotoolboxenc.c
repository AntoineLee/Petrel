                                ...
                                VTCompressionSessionRef *session)
{
    ...
    void         *nums[2];
    int fps = avctx->framerate.num / avctx->framerate.den;
    ...
    VTSessionSetProperty(vtctx->session, kVTCompressionPropertyKey_ExpectedFrameRate, fpsRef);
...
//        CFRelease(cv_img);
    ...
    retainCount = (int)CFGetRetainCount(cv_img);
