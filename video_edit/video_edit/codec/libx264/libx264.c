...
static av_cold int X264_init(AVCodecContext *avctx)
{
    ...
    //VE_LOG_INFO("libx264 init step 1");
    ...
    //VE_LOG_INFO("libx264 init step 2");
    ...
    //VE_LOG_INFO("libx264 init step 3");
    if (avctx->level > 0)
    ...
    //VE_LOG_INFO("libx264 init step 4");
...
FF_ENABLE_DEPRECATION_WARNINGS
    ...
    //VE_LOG_INFO("libx264 init step 5");
    if (avctx->trellis >= 0)
...
FF_ENABLE_DEPRECATION_WARNINGS
    ...
    //VE_LOG_INFO("libx264 init step 6");
    if (x4->fastfirstpass)
...
FF_ENABLE_DEPRECATION_WARNINGS
    ...
    //VE_LOG_INFO("libx264 init step 7");
    ...
    //VE_LOG_INFO("libx264 init step 8");
    if (x4->x264_params) {
    ...
    //VE_LOG_INFO("libx264 open");
    x4->enc = x264_encoder_open(&x4->params);
    if (!x4->enc)
        return AVERROR_EXTERNAL;

    //VE_LOG_INFO("libx264 open done");
    if (avctx->flags & AV_CODEC_FLAG_GLOBAL_HEADER) {
        x264_nal_t *nal;
        uint8_t *p;
        int nnal, s, i;
